...
class TestMockWandbRun:
    def test_init(self, wandb_run) -> None:
    ...
    def test_log(self, wandb_run) -> None:
    ...
    def test_finish(self, wandb_run) -> None:
    ...
    def test_get_logged_data(self, wandb_run) -> None:
        test_data = {"accuracy": 0.95}
