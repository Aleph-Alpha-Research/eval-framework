...
import eval_framework.tasks.benchmarks.piqa_ella_mind as piqa_ella_mind
...
@pytest.mark.parametrize("task_name", get_task_names_for_module("piqa_ella_mind"))
...
def test_piqa_ellamind_mc_easy_de_offline_prompt_formatting() -> None:
    assert_offline_zeroshot_prompt(
        piqa_ella_mind.PIQA_ELLAMIND_MC_EASY_DE,
        eval_row=_EVAL_ROW,
        subjects=[_SUBJECT],
...
def test_piqa_ellamind_mc_hard_de_offline_prompt_formatting() -> None:
    assert_offline_zeroshot_prompt(
        piqa_ella_mind.PIQA_ELLAMIND_MC_HARD_DE,
        eval_row=_EVAL_ROW,
        subjects=[_SUBJECT],
...
def test_piqa_ellamind_cloze_easy_de_offline_prompt_formatting() -> None:
    assert_offline_zeroshot_prompt(
        piqa_ella_mind.PIQA_ELLAMIND_CLOZE_EASY_DE,
        eval_row=_EVAL_ROW,
        subjects=[_SUBJECT],
...
def test_piqa_ellamind_cloze_hard_de_offline_prompt_formatting() -> None:
    assert_offline_zeroshot_prompt(
        piqa_ella_mind.PIQA_ELLAMIND_CLOZE_HARD_DE,
        eval_row=_EVAL_ROW,
        subjects=[_SUBJECT],
...
def test_piqa_ellamind_bpb_de_offline_prompt_formatting() -> None:
    assert_offline_zeroshot_prompt(
        piqa_ella_mind.PIQA_ELLAMIND_BPB_DE,
        eval_row=_EVAL_ROW,
        subjects=[_SUBJECT],
