...
import eval_framework.tasks.benchmarks.hendrycks_math_ella_mind as hendrycks_math_ella_mind
...
@pytest.mark.parametrize("task_name", get_task_names_for_module("hendrycks_math_ella_mind"))
...
def test_mathminervade_olmes_offline_prompt_formatting() -> None:
    assert_offline_zeroshot_prompt(
        hendrycks_math_ella_mind.MATHMinervaDE_OLMES,
        eval_row=_EVAL_ROW,
        subjects=[_SUBJECT],
...
def test_mathminervade_bpb_olmes_offline_prompt_formatting() -> None:
    assert_offline_zeroshot_prompt(
        hendrycks_math_ella_mind.MATHMinervaDE_BPB_OLMES,
        eval_row=_EVAL_ROW,
        subjects=[_SUBJECT],
