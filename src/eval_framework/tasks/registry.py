...
class _Lazy(EvalFactory):
    ...
    def markdown_doc(self, formatters: Sequence[BaseFormatter]) -> str:
        try:
            task = self.create(num_fewshot=1, custom_subjects=None, custom_hf_revision=None, seed=42)
        except (TypeError, ValueError, AssertionError):
            task = self.create(num_fewshot=0, custom_subjects=None, custom_hf_revision=None, seed=42)
