...
from eval_framework.tasks.formatting import ClozeTaskMixin, MCTaskMixin, answer_key_to_index
...
class NaturalQsOpenCloze(ClozeTaskMixin, _NaturalQsOpenChoice_Base):
    NAME = "NaturalQsOpenCloze"


class NaturalQsOpenMC(MCTaskMixin, _NaturalQsOpenChoice_Base):
    NAME = "NaturalQsOpenMC"


class NaturalQsOpenMC_OLMES(MCTaskMixin, _NaturalQsOpenChoice_Base):
