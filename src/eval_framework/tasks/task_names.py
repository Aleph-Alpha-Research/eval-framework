...
def register_all_tasks() -> None:
    ...
    register_lazy_task("eval_framework.tasks.benchmarks.basic_skills.BasicSkillsCloze")
    register_lazy_task("eval_framework.tasks.benchmarks.basic_skills.BasicSkillsMC")
    register_lazy_task("eval_framework.tasks.benchmarks.boolq.BoolQCloze")
    register_lazy_task("eval_framework.tasks.benchmarks.boolq.BoolQMC")
    ...
    register_lazy_task("eval_framework.tasks.benchmarks.paloma.GenericPaloma")
    register_lazy_task("eval_framework.tasks.benchmarks.tydiqa.TyDiQASecondaryTask")
    register_lazy_task("eval_framework.tasks.benchmarks.coqa.CoQA")
    register_lazy_task("eval_framework.tasks.benchmarks.coqa.CoQAMC")
    register_lazy_task("eval_framework.tasks.benchmarks.drop.DropRC")
    register_lazy_task("eval_framework.tasks.benchmarks.drop.DropMC")
    register_lazy_task("eval_framework.tasks.benchmarks.jeopardy.JeopardyCompletion")
    register_lazy_task("eval_framework.tasks.benchmarks.jeopardy.JeopardyMC")
    ...
    register_lazy_task("eval_framework.tasks.benchmarks.copycolors.CopyColorsCloze")
    register_lazy_task("eval_framework.tasks.benchmarks.copycolors.CopyColorsMC")
    ...
    register_lazy_task("eval_framework.tasks.benchmarks.simpleqa.SimpleQACompletion")
    register_lazy_task("eval_framework.tasks.benchmarks.simpletom.SimpleToMMC")
