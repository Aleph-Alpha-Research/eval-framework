...
def register_all_tasks() -> None:
    ...
    register_lazy_task("eval_framework.tasks.benchmarks.arc_ella_mind.ARC_ELLAMIND_BPB_DE")
    register_lazy_task("eval_framework.tasks.benchmarks.arc_ella_mind.ARC_ELLAMIND_CLOZE_DE")
    register_lazy_task("eval_framework.tasks.benchmarks.arc_ella_mind.ARC_ELLAMIND_MC_DE")
    register_lazy_task("eval_framework.tasks.benchmarks.csqa_ella_mind.CSQA_ELLAMIND_BPB_DE")
    register_lazy_task("eval_framework.tasks.benchmarks.csqa_ella_mind.CSQA_ELLAMIND_CLOZE_EASY_DE")
    register_lazy_task("eval_framework.tasks.benchmarks.csqa_ella_mind.CSQA_ELLAMIND_CLOZE_HARD_DE")
    register_lazy_task("eval_framework.tasks.benchmarks.csqa_ella_mind.CSQA_ELLAMIND_MC_EASY_DE")
    register_lazy_task("eval_framework.tasks.benchmarks.csqa_ella_mind.CSQA_ELLAMIND_MC_HARD_DE")
    register_lazy_task("eval_framework.tasks.benchmarks.gpqa_ella_mind.GPQA_ELLAMIND_BPB_DE")
    register_lazy_task("eval_framework.tasks.benchmarks.gpqa_ella_mind.GPQA_ELLAMIND_CLOZE_DE")
    register_lazy_task("eval_framework.tasks.benchmarks.gpqa_ella_mind.GPQA_ELLAMIND_DIAMOND_BPB_DE")
    register_lazy_task("eval_framework.tasks.benchmarks.gpqa_ella_mind.GPQA_ELLAMIND_DIAMOND_CLOZE_DE")
    register_lazy_task("eval_framework.tasks.benchmarks.gpqa_ella_mind.GPQA_ELLAMIND_DIAMOND_MC_DE")
    register_lazy_task("eval_framework.tasks.benchmarks.gpqa_ella_mind.GPQA_ELLAMIND_MC_DE")
    register_lazy_task("eval_framework.tasks.benchmarks.hellaswag_ella_mind.HELLASWAG_ELLAMIND_BPB_DE")
    register_lazy_task("eval_framework.tasks.benchmarks.hellaswag_ella_mind.HELLASWAG_ELLAMIND_EASY_DE")
    register_lazy_task("eval_framework.tasks.benchmarks.hellaswag_ella_mind.HELLASWAG_ELLAMIND_HARD_DE")
    register_lazy_task("eval_framework.tasks.benchmarks.hle_ella_mind.HLE_ELLAMIND_BPB_DE")
    register_lazy_task("eval_framework.tasks.benchmarks.hle_ella_mind.HLE_ELLAMIND_CLOZE_DE")
    register_lazy_task("eval_framework.tasks.benchmarks.hle_ella_mind.HLE_ELLAMIND_CLOZE_NATIVE_DE")
    register_lazy_task("eval_framework.tasks.benchmarks.hle_ella_mind.HLE_ELLAMIND_MC_DE")
    register_lazy_task("eval_framework.tasks.benchmarks.hle_ella_mind.HLE_ELLAMIND_MC_NATIVE_DE")
    register_lazy_task("eval_framework.tasks.benchmarks.humaneval_ella_mind.HumanEvalDE_BPB_OLMES")
    register_lazy_task("eval_framework.tasks.benchmarks.humaneval_ella_mind.HumanEvalDE_OLMES")
    register_lazy_task("eval_framework.tasks.benchmarks.gsm8k_ella_mind.GSM8K_Ellamind_DE_Platinum")
    register_lazy_task("eval_framework.tasks.benchmarks.gsm8k_ella_mind.GSM8K_Ellamind_DE_BPB_Platinum")
    register_lazy_task("eval_framework.tasks.benchmarks.hendrycks_math_ella_mind.MATHMinervaDE_BPB_OLMES")
    register_lazy_task("eval_framework.tasks.benchmarks.hendrycks_math_ella_mind.MATHMinervaDE_OLMES")
    register_lazy_task("eval_framework.tasks.benchmarks.hendrycks_math_ella_mind.MATHMinervaDE_OLMES_NONL")
    register_lazy_task("eval_framework.tasks.benchmarks.mbpp_ella_mind.MBPPDE_BPB_OLMES")
    register_lazy_task("eval_framework.tasks.benchmarks.mbpp_ella_mind.MBPPDE_OLMES")
    register_lazy_task("eval_framework.tasks.benchmarks.mbpp_ella_mind.MBPPDE_BPB_EvalPlus")
    register_lazy_task("eval_framework.tasks.benchmarks.mbpp_ella_mind.MBPPDE_EvalPlus")
    register_lazy_task("eval_framework.tasks.benchmarks.piqa_ella_mind.PIQA_ELLAMIND_BPB_DE")
    register_lazy_task("eval_framework.tasks.benchmarks.piqa_ella_mind.PIQA_ELLAMIND_CLOZE_EASY_DE")
    register_lazy_task("eval_framework.tasks.benchmarks.piqa_ella_mind.PIQA_ELLAMIND_CLOZE_HARD_DE")
    register_lazy_task("eval_framework.tasks.benchmarks.piqa_ella_mind.PIQA_ELLAMIND_MC_EASY_DE")
    register_lazy_task("eval_framework.tasks.benchmarks.piqa_ella_mind.PIQA_ELLAMIND_MC_HARD_DE")
    register_lazy_task("eval_framework.tasks.benchmarks.simpleqa_ella_mind.SIMPLEQA_ELLAMIND_BPB_DE")
    register_lazy_task("eval_framework.tasks.benchmarks.simpleqa_ella_mind.SIMPLEQA_ELLAMIND_CLOZE_EASY_DE")
    register_lazy_task("eval_framework.tasks.benchmarks.simpleqa_ella_mind.SIMPLEQA_ELLAMIND_CLOZE_HARD_DE")
    register_lazy_task("eval_framework.tasks.benchmarks.simpleqa_ella_mind.SIMPLEQA_ELLAMIND_MC_EASY_DE")
    register_lazy_task("eval_framework.tasks.benchmarks.simpleqa_ella_mind.SIMPLEQA_ELLAMIND_MC_HARD_DE")
    register_lazy_task("eval_framework.tasks.benchmarks.siqa_ella_mind.SIQA_ELLAMIND_BPB_DE")
    register_lazy_task("eval_framework.tasks.benchmarks.siqa_ella_mind.SIQA_ELLAMIND_CLOZE_EASY_DE")
    register_lazy_task("eval_framework.tasks.benchmarks.siqa_ella_mind.SIQA_ELLAMIND_CLOZE_HARD_DE")
    register_lazy_task("eval_framework.tasks.benchmarks.siqa_ella_mind.SIQA_ELLAMIND_MC_EASY_DE")
    register_lazy_task("eval_framework.tasks.benchmarks.siqa_ella_mind.SIQA_ELLAMIND_MC_HARD_DE")
    register_lazy_task("eval_framework.tasks.benchmarks.winogrande_ella_mind.WINOGRANDE_ELLAMIND_CLOZE_DE")
    register_lazy_task("eval_framework.tasks.benchmarks.winogrande_ella_mind.WINOGRANDE_ELLAMIND_MC_DE")
    register_lazy_task("eval_framework.tasks.benchmarks.winogrande_ella_mind.WINOGRANDE_ELLAMIND_PARTIAL_EVAL_DE")
