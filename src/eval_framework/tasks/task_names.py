...
def register_all_tasks() -> None:
    ...
    register_lazy_task("eval_framework.tasks.benchmarks.arc.ARCCloze")
    register_lazy_task("eval_framework.tasks.benchmarks.arc.ARCMC")
    register_lazy_task("eval_framework.tasks.benchmarks.arc.ARCBPB")
    ...
    register_lazy_task("eval_framework.tasks.benchmarks.copa.COPAEvalHarness")
    ...
    register_lazy_task("eval_framework.tasks.benchmarks.copa.COPA_IDKEvalHarness")
    ...
    register_lazy_task("eval_framework.tasks.benchmarks.hellaswag.HELLASWAGCloze")
    register_lazy_task("eval_framework.tasks.benchmarks.hellaswag.HELLASWAGMC")
    register_lazy_task("eval_framework.tasks.benchmarks.hellaswag.HELLASWAGBPB")
    ...
    register_lazy_task("eval_framework.tasks.benchmarks.humaneval.CodexHumanEval_BPB")
    ...
    register_lazy_task("eval_framework.tasks.benchmarks.math_reasoning.MATH500Minerva_BPB")
    ...
    register_lazy_task("eval_framework.tasks.benchmarks.mbpp.CodexMBPP_BPB")
    ...
    register_lazy_task("eval_framework.tasks.benchmarks.mmlu.MMLUCloze")
    register_lazy_task("eval_framework.tasks.benchmarks.mmlu.MMLUMC")
    register_lazy_task("eval_framework.tasks.benchmarks.mmlu.MMLUBPB")
    register_lazy_task("eval_framework.tasks.benchmarks.mmlu.MMLUOtherBPB")
    register_lazy_task("eval_framework.tasks.benchmarks.mmlu.MMLUStemBPB")
    register_lazy_task("eval_framework.tasks.benchmarks.mmlu.MMLUHumanitiesBPB")
    register_lazy_task("eval_framework.tasks.benchmarks.mmlu.MMLUSocialSciencesBPB")
    ...
    register_lazy_task("eval_framework.tasks.benchmarks.openbookqa.OPENBOOKQA_OLMES")
    register_lazy_task("eval_framework.tasks.benchmarks.openbookqa.OPENBOOKQA_EVAL_HARNESS")
    register_lazy_task("eval_framework.tasks.benchmarks.openbookqa.OPENBOOKQA_EVAL_HARNESS_OLMES")
    ...
    register_lazy_task("eval_framework.tasks.benchmarks.sciq.SCIQ_IDK")
    register_lazy_task("eval_framework.tasks.benchmarks.sciq.SCIQEvalHarness")
    register_lazy_task("eval_framework.tasks.benchmarks.sciq.SCIQEvalHarness_IDK")
    ...
    register_lazy_task("eval_framework.tasks.benchmarks.squad.SQUAD2BPB")
    ...
    register_lazy_task("eval_framework.tasks.benchmarks.truthfulqa.TRUTHFULQA_OLMES")
    ...
    register_lazy_task("eval_framework.tasks.benchmarks.winogrande.WINOGRANDE_OLMES")
    ...
    register_lazy_task("eval_framework.tasks.benchmarks.csqa.CommonsenseQACloze")
    register_lazy_task("eval_framework.tasks.benchmarks.csqa.CommonsenseQAFullTextCloze")
    ...
    register_lazy_task("eval_framework.tasks.benchmarks.lab_bench.LabBenchCloze")
    register_lazy_task("eval_framework.tasks.benchmarks.lab_bench.LabBenchMC")
    register_lazy_task("eval_framework.tasks.benchmarks.lab_bench.LabBenchMC_OLMES")
