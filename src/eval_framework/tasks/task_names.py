...
def register_all_tasks() -> None:
    ...
    register_lazy_task("eval_framework.tasks.benchmarks.multipl_e.MultiPLEHumanEvalCpp_OLMES")
    register_lazy_task("eval_framework.tasks.benchmarks.multipl_e.MultiPLEHumanEvalJava_OLMES")
    register_lazy_task("eval_framework.tasks.benchmarks.multipl_e.MultiPLEHumanEvalJs_OLMES")
    register_lazy_task("eval_framework.tasks.benchmarks.multipl_e.MultiPLEHumanEvalPhp_OLMES")
    register_lazy_task("eval_framework.tasks.benchmarks.multipl_e.MultiPLEHumanEvalRs_OLMES")
    register_lazy_task("eval_framework.tasks.benchmarks.multipl_e.MultiPLEHumanEvalSh_OLMES")
    register_lazy_task("eval_framework.tasks.benchmarks.multipl_e.MultiPLEMBPPCpp_OLMES")
    register_lazy_task("eval_framework.tasks.benchmarks.multipl_e.MultiPLEMBPPJava_OLMES")
    register_lazy_task("eval_framework.tasks.benchmarks.multipl_e.MultiPLEMBPPJs_OLMES")
    register_lazy_task("eval_framework.tasks.benchmarks.multipl_e.MultiPLEMBPPPhp_OLMES")
    register_lazy_task("eval_framework.tasks.benchmarks.multipl_e.MultiPLEMBPPRs_OLMES")
    register_lazy_task("eval_framework.tasks.benchmarks.multipl_e.MultiPLEMBPPSh_OLMES")
