...
class BaseCompletion(BaseModel):
    ...
    prompt_concat: Annotated[str | None, "The text of the prompt template under the concat formatter."]
    prompt_concat_sequence_positions: Annotated[
        int | None, "Number of sequence positions in the prompt under the concat formatter."
    ]
...
class BaseLoglikelihood(BaseModel):
    ...
    prompt_concat: str | None
    prompt_concat_sequence_positions: int | None
