...
class StopSequenceCriteria(StoppingCriteria):
    ...
    def __call__(self, input_ids: torch.LongTensor, _scores: torch.FloatTensor, **kwargs: Any) -> bool:
...
class RepeatedTokenSequenceCriteria(StoppingCriteria):
    ...
    def __call__(self, input_ids: torch.LongTensor, _scores: torch.FloatTensor, **kwargs: Any) -> torch.Tensor:
