...
* **deps:** update dependency boto3 to &gt;=1.43.97,&lt;2 ([6d5d422](https://github.com/Aleph-Alpha-Research/eval-framework/commit/6d5d422aa896bcb3d1e05d31fb095a1a83e78653))
* **deps:** update dependency openai to &gt;=3.15.0,&lt;4 ([5c2e1b6](https://github.com/Aleph-Alpha-Research/eval-framework/commit/5c2e1b6a10fb20f8eb643b7124c137f2f98d2e55))

## [0.13.4](https://github.com/Aleph-Alpha-Research/eval-framework/compare/v0.13.3...v0.13.4) (2026-09-20)


### Bug Fixes

* **deps:** update dependency boto3 to &gt;=1.43.96,&lt;2 ([ffb24d1](https://github.com/Aleph-Alpha-Research/eval-framework/commit/ffb24d1888eca3a60076af643bcd4a0dde1bb53c))
...
* **deps:** update dependency boto3 to &gt;=1.43.94,&lt;2 ([a3215cc](https://github.com/Aleph-Alpha-Research/eval-framework/commit/a3215ccf9fce241067f604cd2aee70e8d8b35e84))
* **deps:** update dependency openai to &gt;=3.14.0,&lt;4 ([61bfbab](https://github.com/Aleph-Alpha-Research/eval-framework/commit/61bfbab75253c4dd640ad2952d9ecbbb662db7c9))
* **metrics:** replace undecodable bytes in multipl-e sandbox output ([8092db6](https://github.com/Aleph-Alpha-Research/eval-framework/commit/8092db665ff84392c5b296cfea1de9edb77bb58e))
* replace undecodable bytes in python sandbox output ([b44d0b0](https://github.com/Aleph-Alpha-Research/eval-framework/commit/b44d0b0c74bb3d0341febdf8cb50b5f90e1e34c6))
...
* **deps:** update dependency boto3 to &gt;=1.43.92,&lt;2 ([9a56951](https://github.com/Aleph-Alpha-Research/eval-framework/commit/9a5695160c1ca5f54541a709a8ed0d74e2ca1cf5))
* **deps:** update dependency openai to &gt;=3.13.0,&lt;4 ([07b162f](https://github.com/Aleph-Alpha-Research/eval-framework/commit/07b162fe19c5832b37aee1d62b33f8e9ccbfda5a))

## [0.11.15](https://github.com/Aleph-Alpha-Research/eval-framework/compare/v0.11.14...v0.11.15) (2026-09-13)


### Bug Fixes

* **deps:** update dependency accelerate to &gt;=1.15.0,&lt;2 ([b02b601](https://github.com/Aleph-Alpha-Research/eval-framework/commit/b02b60176965fd8fe911b71561370064392a8f0d))
* **deps:** update dependency boto3 to &gt;=1.43.91,&lt;2 ([d89fac8](https://github.com/Aleph-Alpha-Research/eval-framework/commit/d89fac8b54ea73564e5da9a18c67eee30ce68aa4))
* **deps:** update dependency openai to &gt;=3.11.0,&lt;4 ([96e299a](https://github.com/Aleph-Alpha-Research/eval-framework/commit/96e299a03100c96563faa8ac6ce69ea5dcb470d2))
* **deps:** update dependency psycopg2-binary to &gt;=2.9.13,&lt;3 ([f3cf17d](https://github.com/Aleph-Alpha-Research/eval-framework/commit/f3cf17d5ea6b79274401e1ec7c54dbb4e2aea688))

## [0.11.14](https://github.com/Aleph-Alpha-Research/eval-framework/compare/v0.11.13...v0.11.14) (2026-09-12)


### Bug Fixes

* **deps:** update dependency boto3 to &gt;=1.43.90,&lt;2 ([736cc5e](https://github.com/Aleph-Alpha-Research/eval-framework/commit/736cc5e4e74f7c088af52d197e560ecc33b4a45e))
* **deps:** update dependency openai to &gt;=3.10.0,&lt;4 ([9ca238c](https://github.com/Aleph-Alpha-Research/eval-framework/commit/9ca238c5f3cbba6a50975cd57d1e63473a7aad4d))
* **deps:** update dependency wandb to &gt;=0.30.0,&lt;1 ([487d4ca](https://github.com/Aleph-Alpha-Research/eval-framework/commit/487d4ca20ecf00f4fba8f2fcbc3d7d985ddc453d))
...
* **deps:** update dependency boto3 to &gt;=1.43.88,&lt;2 ([c257516](https://github.com/Aleph-Alpha-Research/eval-framework/commit/c2575161b00e095b41073f384a9e5457091e35ea))
* **deps:** update dependency openai to &gt;=3.8.0,&lt;4 ([79a0223](https://github.com/Aleph-Alpha-Research/eval-framework/commit/79a022326ded1c5a295be418a6b9dd985b7f152b))
...
* **deps:** update dependency boto3 to &gt;=1.43.85,&lt;2 ([8e349c9](https://github.com/Aleph-Alpha-Research/eval-framework/commit/8e349c984e0fc55d7860d51ad27c233b80236a25))
